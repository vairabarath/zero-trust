...
- **Controller** (`services/controller/`): Go service. Internal CA + enrollment gRPC server on `:8443`, admin HTTP API on `:8081`. Manages PostgreSQL/SQLite DB, token store, ACLs, and policy distribution.
